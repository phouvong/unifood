...
class AppConstants {
  static const String APP_NAME = 'unifood';
  static const double APP_VERSION = 5.3;
  static const int DIGITS_AFTER_POINT = 0;

  static const String BASE_URL = 'https://admin.unifood.la';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.lo, languageName: 'ພາສາລາວ', countryCode: 'LA', languageCode: 'lo'),
  ];
}
